...
export function PrivacyScannerExperience() {
  ...
  return <>
    <section className="nm-scanner-hero"><div className="nm-scanner-hero__copy"><span className="nm-eyebrow">Privacy Scanner</span><h1>What's hiding in your photo?</h1><p>Scan hidden metadata before you share. Your photo stays in your browser while NoMeta checks it.</p><input ref={inputRef} className="nm-visually-hidden" type="file" accept="image/jpeg,image/png,image/webp,image/heic,image/heif,.heic,.heif" multiple onChange={e => e.target.files && addFiles(e.target.files)} /><div className="nm-scanner-hero__actions"><Button variant="primary" icon="upload" onClick={() => inputRef.current?.click()}>Choose a photo</Button><span>JPG · PNG · WebP · HEIC · HEIF · up to 50 MB</span></div><div className="nm-scanner-privacy"><Icon name="lock" /><span><strong>Private by design.</strong> Scanning happens locally in your browser.</span></div></div><div className="nm-scanner-visual" aria-hidden="true"><div className="nm-scanner-visual__orbit nm-scanner-visual__orbit--one" /><div className="nm-scanner-visual__orbit nm-scanner-visual__orbit--two" /><div className="nm-scanner-visual__frame"><div className="nm-scanner-visual__photo"><span className="nm-scanner-visual__scanline" /><i /><i /><i /></div><div className="nm-scanner-visual__chips"><span>GPS</span><span>DEVICE</span><span>TIME</span><span>AUTHOR</span></div></div></div></section>
